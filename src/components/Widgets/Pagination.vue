    ...
    <ul class="pagination">
      <li class="pagination-item">
        <button type="button" @click="onClickFirstPage" :disabled="isInFirstPage" aria-label="Allez a la premiere page">
          <Icon icon="carbon:page-first" color="#ff8f9a" width="24" height="24" />
        </button>
      </li>
      ...
      <li class="pagination-item">
        ...
        >
          <Icon icon="carbon:previous-filled" color="#ff8f9a" width="24" height="24" />
        </button>
      </li>
      ...
      <li class="pagination-item">
        <button type="button" @click="onClickNextPage" :disabled="isInLastPage" aria-label="Allez a la page suivante">
          <Icon icon="carbon:next-filled" color="#ff8f9a" width="24" height="24" />
        </button>
      </li>

      <li class="pagination-item">
        <button type="button" @click="onClickLastPage" :disabled="isInLastPage" aria-label="Allez a la derniere page">
          <Icon icon="carbon:page-last" color="#ff8f9a" width="24" height="24" />
        </button>
      </li>
    </ul>
  </div>
